...
export const CopyrightYearText = component$((props: { class?: ClassList }) => {
  const code = useSignal("1h1Gcqd2rQiDnPo5GlrlZD24nCrQJS2Qv5asfkMJkIdUKF7cbbRNA1AgJegikIgF0gU0"); // logo-text-01
