...
export const PlainText = component$((props: { class?: ClassList }) => {
  const code = useSignal("150e3zi0Gr4dplk2JLr3WQLK2tFMT8zVoPGBAE3Qtdg2tjjg1OyoGGlY"); // logo-text-01
