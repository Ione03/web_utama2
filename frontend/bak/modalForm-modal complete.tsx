...
export const ModalForm = component$<EditModalProps>(({ isOpen, onOpen, onClose, formData }) => {
  ...
  // Use internal state if no external isOpen prop provided
  const modalIsOpen = isOpen !== undefined ? isOpen : internalIsOpen.value;
  ...
  // Auto open/close berdasarkan prop isOpen (if controlled externally)
